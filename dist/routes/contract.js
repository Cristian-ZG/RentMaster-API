...
router.post('/', validate_token_1.default, contract_1.postContract);
router.put('/:contract_id', validate_token_1.default, contract_1.updateContract);
router.get('/', validate_token_1.default, contract_1.getContracts);
